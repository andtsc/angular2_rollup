...
System.import('/base//system.config.js')
  .then(initTestBed)
  .then(initTesting);
...
function initTestBed(){
  return Promise.all([
    System.import('/base//lib/@angular/core/bundles/core-testing.umd.js'),
    System.import('/base//lib/@angular/platform-browser-dynamic/bundles/platform-browser-dynamic-testing.umd.js')
  ])
